...
<html lang="en">
  <head>
    ...
    <!-- Loading Bootstrap -->
    <link href="${basePath }common/dist/css/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Loading Flat UI -->
    <link href="${basePath }common/dist/css/flat-ui.css" rel="stylesheet">
    <link href="${basePath }common/docs/assets/css/demo.css" rel="stylesheet">

    <link rel="shortcut icon" href="${basePath }common/img/favicon.ico">
  ...
  <body>
    <div class="container">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="base/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="base/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="base/img/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="base/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="base/img/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="base/img/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="base/img/icons/svg/map.svg" alt="Map"></div>
          <div><img src="base/img/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="base/img/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="base/img/icons/svg/book.svg" alt="Book"></div>
          <div><img src="base/img/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="base/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="base/img/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="base/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-tiles">
        <div class="col-xs-3">
          <div class="tile">
            <img src="base/img/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="base/img/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="base/img/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile tile-hot">
            <img src="base/img/icons/svg/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
            <img src="base/img/icons/svg/chat.svg" alt="Chat" class="tile-image">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="base/img/login/icon.png" alt="Welcome to Mail App" />
